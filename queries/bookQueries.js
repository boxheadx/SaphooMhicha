...
const getTopBooks = "SELECT b.book_id, b.title, b.isbn, b.publication_date, b.publisher, b.language, b.cover_image_url, b.description, AVG(r.rating) AS average_rating FROM Books b JOIN Reviews r ON b.book_id = r.book_id GROUP BY b.book_id ORDER BY average_rating DSC";
